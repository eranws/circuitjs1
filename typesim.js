var CirSim = /** @class */ (function () {
    function CirSim() {
    }
    CirSim.prototype.init = function () {
        throw new Error("Method not implemented.");
    };
    CirSim.prototype.setCanvasSize = function () {
        throw new Error("Method not implemented.");
    };
    CirSim.prototype.setiFrameHeight = function () {
        throw new Error("Method not implemented.");
    };
    CirSim.prototype.updateCircuit = function () {
        runCircuit();
    };
    return CirSim;
}());
// static CirSim mysim;
var mysim = new CirSim();
mysim.init();
